...
def start(message):
    ...
    try:
        ...
        bot.send_message(
            message.chat.id,
            "اهلا وسهلا بك في بوت الحماية المتطور المقدم من سورس سوريا!",
            reply_markup=markup
        )
...
def settings_callback(call):
    ...
    if call.data == "toggle_violence":
        ...
        bot.answer_callback_query(call.id, "فتح إدارة الكلمات المحظورة.")
        markup = telebot.types.InlineKeyboardMarkup(row_width=1)
        ...
        bot.edit_message_text(
            ...
            "استخدم /l1 لإضافة كلمة محظورة، و /l1l لإزالتها.\n"
            "مثال: /l1 كلمة\n"
            "/l1l كلمة",
            call.message.chat.id,
            call.message.message_id,
