...
def start(message):
    ...
    try:
        ...
        bot.send_message(
            message.chat.id,
            "اهلا بك في بوت لحماية المتطور الخاص بلميديا المقدم من سورس سوريا 🇸🇾 \n"
            "للمزيد من الخيارات استعمل في المجموعة /setting واتبع التعليمات للاطلاع على اشتراكك في البوت استخدم الامر /subscription",
            reply_markup=markup
        )
