...
# حذف: processed_messages = set()  # حذف متغير تتبع الرسائل
...
# معالجة الصور (مع التحقق من التفعيل فقط) # معدل: حذف شرط processed_messages
...
# معالجة الملصقات (مع التحقق من التفعيل فقط) # معدل: حذف شرط processed_messages
...
# معالجة الفيديوهات (مع التحقق من التفعيل فقط) # معدل: حذف شرط processed_messages
...
# معالجة الصور المتحركة (GIF) (مع التحقق من التفعيل فقط) # معدل: حذف شرط processed_messages
...
# معالجة الرموز التعبيرية المميزة (مع التحقق من التفعيل فقط) # معدل: حذف شرط processed_messages
...
# معالجة الرسائل المعدلة (نصوص تحتوي على رموز تعبيرية مميزة) # معدل: حذف شرط processed_messages
...
# معالجة الميديا المعدلة # معدل: حذف شرط processed_messages
...
# مثال ميزة إضافية (/ban_user) مع دمج الاشتراك (يمكن حذفها إذا لم تريدها)
